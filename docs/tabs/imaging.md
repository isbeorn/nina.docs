...
9.   Activates the Bahtinov Analyzer aid tool for manual focusing with a Bathinov Mask.
...
3. Focuser temperature (if the focuser is eqiopped with an ambient temperature chip)
...
When you have to manual focus your scope this hndy tab lets you conveniently choose among the current visible brighter stars according to your location and time to slew your telescope to.
