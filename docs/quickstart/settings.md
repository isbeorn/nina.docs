...
Bit depth will be kept at 16 bit for most cameras, as this does not refer to the sensor bit depth but at the actual raw data depth that the camera driver produces. Most drivers will scale this automatically to be 16 bit. When using the native Canon or Nikon driver, enter the real bit depth of your camera instead.
