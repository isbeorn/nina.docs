...
## Approach 1   
[The Simple Sequencer](./simple/simple.md)    
...
Due to the vast range of different equipment and use cases in the astrophotography area, the needs of the simple sequencer couldn't serve the more specialized use cases. Adding more and more edge cases to the simple sequencer was no option as that would clog up the user interface for the majority of users that won't even need these special features. Out of this need the advanced sequencer was born. This new approach offers a completely different way of setting up sequences on a fine granular level.  
