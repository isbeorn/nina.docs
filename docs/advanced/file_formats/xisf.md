...
Extensible Image Serialization Format (XISF) is an image file format created by PixInsight. It is a free format open to contributions of anyone interested. For more detailed information about the format itself refer to [pixinsight.com/xisf](//pixinsight.com/xisf/).
...
## [Observation Namespace](//pixinsight.com/doc/docs/XISF-1.0-spec/XISF-1.0-spec.html#__XISF_Core_Elements_:_Image_Core_Element_:_Astronomical_Image_Properties_:_Observation_Namespace__)
...
### Location
- Elevation: Elevation specified in the astrometry settings
...
## [Instrument Namespace](//pixinsight.com/doc/docs/XISF-1.0-spec/XISF-1.0-spec.html#__XISF_Core_Elements_:_Image_Core_Element_:_Astronomical_Image_Properties_:_Instrument_Namespace__)
...
!!! tip 
    Additionally all information that is explained [in the FITS description](fits.md) is stored using the [FITSKeyword Core Element](//pixinsight.com/doc/docs/XISF-1.0-spec/XISF-1.0-spec.html#__XISF_Core_Elements_:_FITSKeyword_Core_Element__).
...
- Zstandard (ZSTD): A modern lossless compressor that offers a useful balance between compression ratio and speed.
...
!!! tip
    For a more in depth info on how the compression works refer to the [XISF Data Block Compression](//pixinsight.com/doc/docs/XISF-1.0-spec/XISF-1.0-spec.html#data_block_compression)
...
!!! tip
    For a more in depth info on how the checksum works refer to the [XISF Data Block Checksum](//pixinsight.com/doc/docs/XISF-1.0-spec/XISF-1.0-spec.html#data_block_checksum)
